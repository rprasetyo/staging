     ...
     foreach ($all_categories as $cat) {
	    if($cat->category_parent == 0) {
			...
			<?php } ?>
					...
					<div class="item-cat">
						<?php if ( $image ) { ?>
							<a class="cat-img tbay-image-loaded" href="<?php echo get_term_link($cat->slug, 'product_cat'); ?>">
	            ...
	            foreach($sub_cats as $sub_category) {
	            	...
	            	?> 
						...
						<?php } ?>
								...
								<div class="item-cat">
									<?php if ( $image_sub ) { ?>
										<a class="cat-img tbay-image-loaded" href="<?php echo get_term_link($sub_category->slug, 'product_cat'); ?>">
											<?php greenmart_tbay_src_image_loaded($image_sub); ?>
										</a>
									<?php } ?>
