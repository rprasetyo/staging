...
switch ( $source ) {
	...
	case 'featured_image':
		...
		$img = array( 
				'thumbnail' => greenmart_tbay_src_image_loaded($custom_src, array(
	...
	case 'external_link':
		...
		$img = array( 
			'thumbnail' => greenmart_tbay_src_image_loaded($custom_src, array('class' => 'vc_single_image-img', 'alt' => ""), $hwstring , false),
		);
...
if ( ! $img ) {
	$img['thumbnail'] = greenmart_tbay_src_image_loaded($default_src, array('class' => 'vc_img-placeholder vc_single_image-img'), false);
}
