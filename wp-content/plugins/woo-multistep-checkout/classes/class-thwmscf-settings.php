	...
	public function get_settings_fields(){
		...
		$layout_field = array(
			...
			'enable_login_step' => array(
				'name'=>'enable_login_step', 'label'=>__('Display login step', 'woo-multistep-checkout'), 'type'=>'checkbox', 'value'=>'yes', 'checked'=>1, 'onchange'=>'thwmscfDisplayLogin(this)',
			),
			...
			'title_login' => array(
				'name'=>'title_login', 'label'=>__('Login', 'woo-multistep-checkout'), 'type'=>'text', 'value'=>'Login'
			),
			'title_billing' => array(
				'name'=>'title_billing', 'label'=>__('Billing details', 'woo-multistep-checkout'), 'type'=>'text', 'value'=>'Billing details'
			),
			'title_shipping' => array(
				'name'=>'title_shipping', 'label'=>__('Shipping details', 'woo-multistep-checkout'), 'type'=>'text', 'value'=>'Shipping details'
			),
			'title_order_review' => array(
				'name'=>'title_order_review', 'label'=>__('Your order', 'woo-multistep-checkout'), 'type'=>'text', 'value'=>'Your order'
			),
			...
			'thwmscf_layout' => array( 
				'name'=>'thwmscf_layout', 'label'=>__('Multistep Layout', 'woo-multistep-checkout'), 'type'=>'radio', 'value'=>'thwmscf_horizontal_box', 'options'=> $layout_options,					
			),
			...
			'back_to_cart_button_text' => array(
				'name'=>'back_to_cart_button_text', 'label'=>__('Back to cart button', 'woo-multistep-checkout'), 'type'=>'text', 'value'=>'Back to cart',
			),
		);
	...
	public function render_form_field_element($field, $atts=array(), $render_cell=true){
		if($field && is_array($field)){
			...
			if($ftype == 'text'){
				...
				$args['input_cell_props'] = 'style="width: 25%;" class="forminp thwmscf_layout_wrap"';
