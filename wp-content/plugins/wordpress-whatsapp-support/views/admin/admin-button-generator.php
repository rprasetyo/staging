    ...
    <div class="flex-grid flex-grid-2">
            ...
            <div class="flex-grid flex-grid-2">
                ...
                <div class="col">
                    <div class="wws-admin-field">
                        ...
                        <input type="text" id="wws-button-gen-bg-color" class="wecreativez-color-field" value="#22c15e">
                    </div>
                </div>
                <div class="col">
                    <div class="wws-admin-field">
                        <label for=""><?php esc_html_e( 'Button Text Color', 'wc-wws' ) ?></label>
                        <input type="text" id="wws-button-gen-text-color" class="wecreativez-color-field" value="#fff">
                    </div>
                </div>
        ...
        <div class="col">
            ...
            <div class="wws-button-gen-visual-representation">
                ...
                <button id="wws-button-gen-btn-visual"><i class="wc-fa wc-fa-whatsapp"></i> Contact Us</button>
