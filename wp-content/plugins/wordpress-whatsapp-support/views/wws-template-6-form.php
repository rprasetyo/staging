...
<input type="tel" class="wws-popup__fields-number" placeholder="<?php echo esc_attr( $setting['text_number_placeholder'] ) ?>">

<div class="wws-popup__fields-textarea-wrapper">
    
    <textarea name="" class="wws-popup__input wws-popup__fields-textarea" placeholder="<?php echo esc_attr( $setting['text_input_placeholder'] ) ?>"></textarea>
    
    <svg class="wws-popup__send-btn" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 40 40" style="enable-background:new 0 0 40 40;" xml:space="preserve">
    <style type="text/css">
    .wws-lau00001{fill:<?php echo esc_html( $setting['ui_layout_bg_color'] ) ?>80;}
    .wws-lau00002{fill:<?php echo esc_html( $setting['ui_layout_bg_color'] ) ?>;}
        </style>
